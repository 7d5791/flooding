...
class Mac1609_4 : public BaseMacLayer,
	...
	public:
		...
		long getSentPackets ();
		long getTXRXLostPackets ();
		long getSNIRLostPackets ();
		long getDroppedPackets ();
		long getNumTooLittleTime ();
		long getNumInternalContention ();
		long getNumBackoff ();
		long getSlotsBackoff ();
		simtime_t getTotalBusyTime ();
		simtime_t getMyIdleTime ();
		long getNumSuccessfullTx();
		void setMyDIF(simtime_t chdif);
		simtime_t getMyDIF();

		double gethRecvPower_dBm();
		double gethBitrate();
		double gethSnr();
		long  gethSlotsBackoff();
		long  gethNumBackoff();
		long  gethNumInternalContention();
